...
GSY Node Order Book pallets are described below, while the Trade Settlement pallet and the Trade Execution pallets are described as components of the GSY DEX Matching Engine and the GSY DEX Execution Engine, respectively.
