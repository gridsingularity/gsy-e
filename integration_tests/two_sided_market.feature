Feature: Two sided market tests
  ...
  Scenario: One storage, one load
     ...
     When we run the d3a simulation on console with two_sided_market.one_load_one_storage for 24 hrs (60, 60)
  ...
  Scenario: One pv, one load
     ...
     And d3a is installed
     When we run the d3a simulation on console with two_sided_market.one_pv_one_load for 24 hrs slot_length: 60m, tick_length: 60s and markets: 4
  ...
  Scenario: One storage, one pv
     ...
     And d3a is installed
     When we run the d3a simulation on console with two_sided_market.one_pv_one_storage for 24 hrs slot_length: 60m, tick_length: 60s and markets: 4
  ...
  Scenario: 5 pv, one load
     ...
     And d3a is installed
     When we run the d3a simulation on console with two_sided_market.one_load_5_pv_partial for 24 hrs slot_length: 60m, tick_length: 60s and markets: 4
  ...
  Scenario: 5 pv, one storage
     ...
     And d3a is installed
     When we run the d3a simulation on console with two_sided_market.one_storage_5_pv_partial for 24 hrs (60, 60)
  ...
  Scenario: LoadHoursStrategy buys energy in the min energy rate
    ...
    And d3a is installed
    When we run the d3a simulation on console with two_sided_market.one_cep_one_load for 24 hrs slot_length: 60m, tick_length: 60s and markets: 4
