Feature: Two sided market tests
  ...
  Scenario: One storage, one load
     ...
     When we run the simulation with setup file two_sided_market.one_load_one_storage and parameters [None, 24, 15, 15, 0, 1]
  ...
  Scenario: One pv, one load
     ...
     And d3a is installed
     When we run the simulation with setup file two_sided_market.one_pv_one_load and parameters [None, 24, 15, 15, 0, 4]
  ...
  Scenario: One storage, one pv
     ...
     And d3a is installed
     When we run the simulation with setup file two_sided_market.one_pv_one_storage and parameters [None, 24, 15, 15, 0, 4]
  ...
  Scenario: 5 pv, one load
     ...
     And d3a is installed
     When we run the simulation with setup file two_sided_market.one_load_5_pv_partial and parameters [None, 24, 15, 15, 0, 4]
  ...
  Scenario: 5 pv, one storage
     ...
     And d3a is installed
     When we run the simulation with setup file two_sided_market.one_storage_5_pv_partial and parameters [None, 24, 15, 15, 0, 4]
  ...
  Scenario: LoadHoursStrategy buys energy in the min rate range provided by the user as dict profile
    ...
    And d3a is installed
    When we run the simulation with setup file two_sided_market.user_min_rate_profile_load_dict and parameters [None, 24, 15, 15, 1, 4]
  ...
  Scenario: LoadHoursStrategy buys energy in the min energy rate
    ...
    And d3a is installed
    When we run the simulation with setup file two_sided_market.one_cep_one_load and parameters [None, 24, 15, 15, 0, 4]
