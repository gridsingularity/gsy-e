Feature: KPI integration tests
  ...
  Scenario: House is not self sufficient
     ...
     Then the export functionality of kpi of {'Grid': 1.0, 'House 1': 0.0} are correctly reported
  ...
  Scenario: House is fully self sufficient
     ...
     Then the export functionality of kpi of {'Grid': 1.0, 'House 1': 1.0} are correctly reported
  ...
  Scenario: House is partially self sufficient
     ...
     Then the export functionality of kpi of {'Grid': 1.0, 'House 1': 0.34925} are correctly reported
