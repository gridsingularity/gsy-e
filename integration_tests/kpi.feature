Feature: KPI integration tests
  ...
  Scenario: House is not self sufficient
     ...
     When we run the gsy_e simulation on console with kpi.house_not_self_sufficient for 24 hrs
  ...
  Scenario: House is fully self sufficient
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.house_fully_self_sufficient for 24 hrs
  ...
  Scenario: House is partially self sufficient
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.house_partially_self_sufficient for 24 hrs
  ...
  Scenario: House fully self_sufficiency with storage
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.house_self_sufficient_with_ess for 24 hrs
     Then self_sufficiency of {'Grid': 1.0, 'House 1': 1.0} are correctly reported
  ...
  Scenario: Root Area fully self_sufficiency with InfinitBus
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.root_area_self_sufficient_with_infinitebus for 24 hrs
  ...
  Scenario: D3ASIM-2103, self sufficiency reports correct values on levels higher than houses for SSM
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.d3asim_2103 for 24 hrs (30, 30)
  ...
  Scenario: D3ASIM-2103, self sufficiency reports correct values on levels higher than houses for PAB
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.d3asim_2103_2_sided_pab for 24 hrs (30, 30)
  ...
  Scenario: D3ASIM-2103, self sufficiency reports correct values on levels higher than houses with energy deficit for SSM
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.d3asim_2103_nopv1 for 24 hrs (30, 30)
  ...
  Scenario: D3ASIM-2103, self sufficiency reports correct values on levels higher than houses with energy deficit for PAB
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.d3asim_2103_nopv1_2_sided_pab for 24 hrs (30, 30)
  ...
  Scenario: D3ASIM-2262, self sufficiency reports correct values on community that includes storage
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.d3asim_2262 for 24 hrs (30, 30)
  ...
  Scenario: self-sufficiency, self-consumption & total_energy_demanded are correctly reported
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.market_maker_and_load for 24 hrs (60, 30)
     Then self_sufficiency of {'Grid': 1.0} are correctly reported
     And self_consumption of {'Grid': 1.0} are correctly reported
  ...
  Scenario: D3ASIM-2417: KPI is correctly reported for InfiniteBus
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with kpi.infinitebus_pv_load for 24 hrs (15, 15)
