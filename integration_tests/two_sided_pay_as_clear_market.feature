Feature: Two sided pay_as_clear market tests
  ...
  Scenario: Test offers, bids and market-clearing-rate are exported
     Given we have a scenario named two_sided_pay_as_clear/default_2a
     And gsy_e is installed
     When we run the gsy_e simulation on console with two_sided_pay_as_clear.default_2a for 2 hrs
  ...
  Scenario: Test offers, bids trades and stats are exported also for settlement markets.
     ...
     And gsy_e is installed
     When we run the gsy_e simulation on console with settlement_market.default_2a_settlement for 2 hrs
  ...
  Scenario: Supply Demand Curve
     ...
     When we run the gsy_e simulation on console with two_sided_pay_as_clear.test_clearing_energy for 24 hrs
