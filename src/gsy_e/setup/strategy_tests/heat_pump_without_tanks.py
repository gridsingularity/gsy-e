...
from gsy_e.models.strategy.heat_pump import HeatPumpStrategyWithoutTanks
                ...
                [
                    Area(
                        ...
                        strategy=HeatPumpStrategyWithoutTanks(
                            ...
                            target_temp_C_profile=os.path.join(
                                gsye_root_path, "resources", "hp_internal_temp_C.csv"
                            ),
                        ),
                    ),
                ],
