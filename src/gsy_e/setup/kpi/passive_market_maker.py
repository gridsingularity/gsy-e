...
from gsy_e.models.strategy.passive_market_maker import PassiveMarketMakerStrategy
...
def get_setup(config):
    area = Area(
        ...
        [
            ...
            Area("Market Maker",
                 strategy=PassiveMarketMakerStrategy(initial_soc=50)
                 ),
            ...
            Area(
                ...
                [
                    ...
                    Area("H4 PV", strategy=PVStrategy(4,
                                                      initial_selling_rate=60,
            ...
            Area(
                ...
                [
                    ...
                    Area("H5 PV", strategy=PVStrategy(4,
                                                      initial_selling_rate=60,
                                                      final_selling_rate=5),
                         ),
