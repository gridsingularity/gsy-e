...
class TwoSidedEngine(MAEngine):
    ...
    def event_bid_split(self, *, market_id: str, original_bid: Bid,
        ...
        self.owner.log.debug(f"Bid {short_orders_log_str(local_bid)} was split into "
                             f"{short_orders_log_str(local_split_bid)} and "
                             f"{short_orders_log_str(local_residual_bid)}")
