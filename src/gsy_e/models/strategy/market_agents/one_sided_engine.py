...
class MAEngine:
    ...
    def event_offer_split(self, *, market_id, original_offer, accepted_offer, residual_offer):
        ...
        self.owner.log.debug(f"Offer {short_orders_log_str(local_offer)} was split into "
                             f"{short_orders_log_str(local_split_offer)} and "
                             f"{short_orders_log_str(local_residual_offer)}")
