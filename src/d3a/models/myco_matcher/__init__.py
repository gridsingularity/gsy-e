...
class MycoMatcher:
    def __init__(self):
        ...
        if ConstSettings.IAASettings.BID_OFFER_MATCH_TYPE == BidOfferMatchEnum.PAY_AS_BID.value:
            self.match_algorithm = PayAsBidMatch()
        elif ConstSettings.IAASettings.BID_OFFER_MATCH_TYPE == \
                BidOfferMatchEnum.PAY_AS_CLEAR.value:
    ...
    def calculate_recommendation(self, bids, offers, current_time):
        ...
        self.bid_offer_pairs = self.match_algorithm.calculate_match_recommendation(
