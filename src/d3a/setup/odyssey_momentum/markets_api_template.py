...
class AutoAggregator(Aggregator_type):
    ...
    def on_market_cycle(self, market_info):
        ...
        # day 1
        planed_fee = {('2014-10-01T00:30', 'Grid'): 5}
        planed_fee.update({('2014-10-01T00:30', 'Community'): 3})
        planed_fee.update({('2014-10-01T09:00', 'Grid'): 1})
        planed_fee.update({('2014-10-01T09:00', 'Community'): 2})
        planed_fee.update({('2014-10-01T11:30', 'Grid'): 12})
        planed_fee.update({('2014-10-01T11:30', 'Community'): 0})
        planed_fee.update({('2014-10-01T14:00', 'Grid'): 5})
        planed_fee.update({('2014-10-01T14:00', 'Community'): 3})
        planed_fee.update({('2014-10-01T19:00', 'Grid'): 10})
        planed_fee.update({('2014-10-01T19:00', 'Community'): 1})
        planed_fee.update({('2014-10-01T21:00', 'Grid'): 5})
        planed_fee.update({('2014-10-01T21:00', 'Community'): 3})
        # day 2
        planed_fee.update({('2014-10-02T09:00', 'Grid'): 1})
        planed_fee.update({('2014-10-02T09:00', 'Community'): 2})
        planed_fee.update({('2014-10-02T11:30', 'Grid'): 12})
        planed_fee.update({('2014-10-02T11:30', 'Community'): 0})
        planed_fee.update({('2014-10-02T14:00', 'Grid'): 5})
        planed_fee.update({('2014-10-02T14:00', 'Community'): 3})
        planed_fee.update({('2014-10-02T19:00', 'Grid'): 10})
        planed_fee.update({('2014-10-02T19:00', 'Community'): 1})
        planed_fee.update({('2014-10-02T21:00', 'Grid'): 5})
        planed_fee.update({('2014-10-02T21:00', 'Community'): 3})
        # day 3
        planed_fee.update({('2014-10-03T09:00', 'Grid'): 1})
        planed_fee.update({('2014-10-03T09:00', 'Community'): 2})
        planed_fee.update({('2014-10-03T11:30', 'Grid'): 12})
        planed_fee.update({('2014-10-03T11:30', 'Community'): 0})
        planed_fee.update({('2014-10-03T14:00', 'Grid'): 5})
        planed_fee.update({('2014-10-03T14:00', 'Community'): 3})
        planed_fee.update({('2014-10-03T19:00', 'Grid'): 10})
        planed_fee.update({('2014-10-03T19:00', 'Community'): 1})
        planed_fee.update({('2014-10-03T21:00', 'Grid'): 5})
        planed_fee.update({('2014-10-03T21:00', 'Community'): 3})
        # day 4
        planed_fee.update({('2014-10-04T09:00', 'Grid'): 1})
        planed_fee.update({('2014-10-04T09:00', 'Community'): 2})
        planed_fee.update({('2014-10-04T11:30', 'Grid'): 12})
        planed_fee.update({('2014-10-04T11:30', 'Community'): 0})
        planed_fee.update({('2014-10-04T14:00', 'Grid'): 5})
        planed_fee.update({('2014-10-04T14:00', 'Community'): 3})
        planed_fee.update({('2014-10-04T19:00', 'Grid'): 10})
        planed_fee.update({('2014-10-04T19:00', 'Community'): 1})
        planed_fee.update({('2014-10-04T21:00', 'Grid'): 5})
        planed_fee.update({('2014-10-04T21:00', 'Community'): 3})
        # day 5
        planed_fee.update({('2014-10-05T09:00', 'Grid'): 1})
        planed_fee.update({('2014-10-05T09:00', 'Community'): 2})
        planed_fee.update({('2014-10-05T11:30', 'Grid'): 12})
        planed_fee.update({('2014-10-05T11:30', 'Community'): 0})
        planed_fee.update({('2014-10-05T14:00', 'Grid'): 5})
        planed_fee.update({('2014-10-05T14:00', 'Community'): 3})
        planed_fee.update({('2014-10-05T19:00', 'Grid'): 10})
        planed_fee.update({('2014-10-05T19:00', 'Community'): 1})
        planed_fee.update({('2014-10-05T21:00', 'Grid'): 5})
        planed_fee.update({('2014-10-05T21:00', 'Community'): 3})
        # day 6
        planed_fee.update({('2014-10-06T09:00', 'Grid'): 1})
        planed_fee.update({('2014-10-06T09:00', 'Community'): 2})
        planed_fee.update({('2014-10-06T11:30', 'Grid'): 12})
        planed_fee.update({('2014-10-06T11:30', 'Community'): 0})
        planed_fee.update({('2014-10-06T14:00', 'Grid'): 5})
        planed_fee.update({('2014-10-06T14:00', 'Community'): 3})
        planed_fee.update({('2014-10-06T19:00', 'Grid'): 10})
        planed_fee.update({('2014-10-06T19:00', 'Community'): 1})
        planed_fee.update({('2014-10-06T21:00', 'Grid'): 5})
        planed_fee.update({('2014-10-06T21:00', 'Community'): 3})
        # day 7
        planed_fee.update({('2014-10-07T09:00', 'Grid'): 1})
        planed_fee.update({('2014-10-07T09:00', 'Community'): 2})
        planed_fee.update({('2014-10-07T11:30', 'Grid'): 12})
        planed_fee.update({('2014-10-07T11:30', 'Community'): 0})
        planed_fee.update({('2014-10-07T14:00', 'Grid'): 5})
        planed_fee.update({('2014-10-07T14:00', 'Community'): 3})
        planed_fee.update({('2014-10-07T19:00', 'Grid'): 10})
        planed_fee.update({('2014-10-07T19:00', 'Community'): 1})
        planed_fee.update({('2014-10-07T21:00', 'Grid'): 5})
        planed_fee.update({('2014-10-07T21:00', 'Community'): 3})
