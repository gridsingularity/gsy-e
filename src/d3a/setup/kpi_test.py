...
def get_setup(config):
    ...
    ConstSettings.StorageSettings.MIN_ALLOWED_SOC = 0.0
    area = Area(
        'Grid',
        [
            # Area('Street 1', [
                ...
                Area(
                    ...
                    [
                        ...
                        Area('H4 PV', strategy=PVStrategy(3, 60),
                             appliance=PVAppliance()),
                        Area('H4 Storage1', strategy=StorageStrategy(initial_capacity_kWh=0),
                             appliance=SwitchableAppliance()),
                ...
                Area(
                    ...
                    [
                        ...
                        Area('H5 PV', strategy=PVStrategy(1, 60),
                             appliance=PVAppliance()),
                        Area('H5 Storage1', strategy=StorageStrategy(initial_capacity_kWh=0),
                             appliance=SwitchableAppliance()),
                        Area('H5 Storage2', strategy=StorageStrategy(initial_capacity_kWh=0),
                             appliance=SwitchableAppliance()),
                    ]
                ),
            ]
