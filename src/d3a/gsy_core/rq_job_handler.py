...
from d3a.gsy_core.util import available_simulation_scenarios, update_advanced_settings
...
def launch_simulation_from_rq_job(scenario, settings, events, aggregator_device_mapping,
    ...
    try:
        ...
        import traceback
        from d3a.gsy_core.redis_connections.redis_communication import publish_job_error_output
