...
class ExportUnmatchedLoads:
    ...
    def accumulate_unmatched_load(cls, area):
        ...
        return {"unmatched_hours": unmatched_times, "unmatched_load_count": len(unmatched_times)}
