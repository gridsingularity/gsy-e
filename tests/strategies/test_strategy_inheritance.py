...
from gsy_e.models.strategy.external_strategies.load import (
    LoadProfileExternalStrategy, LoadProfileForecastExternalStrategy)
...
class TestStrategyInheritance:
    ...
    @staticmethod
    @pytest.mark.parametrize("attr_name, strategy_classes", [
        ["daily_load_profile_uuid", [DefinedLoadStrategy,
        ...
        ["energy_rate_profile_uuid", [MarketMakerStrategy,
                                      InfiniteBusStrategy]],
        ["buying_rate_profile_uuid", [InfiniteBusStrategy]]

    ])
    def test_profile_uuids_are_part_of_strategy_attrs(attr_name, strategy_classes):
        """
        ...
        for strategy_class in strategy_classes:
            ...
            strategy_class._read_or_rotate_profiles = Mock()
