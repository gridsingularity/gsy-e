...
from d3a.models.market.market_structures import Offer, Trade, TradeBidInfo
...
class TestMarketRedisEventSubscriber(unittest.TestCase):
    ...
    def test_sanitize_parameters(self):
        ...
        assert isinstance(output_data["trade_bid_info"], TradeBidInfo)
