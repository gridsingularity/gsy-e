...
from d3a.gsy_e_core.redis_connections.aggregator_connection import AggregatorHandler
...
def strict_redis():
    with patch("d3a.gsy_e_core.redis_connections.redis_area_market_communicator.StrictRedis",
               spec=StrictRedis):
...
def aggregator_handler():
    with patch(
            "d3a.gsy_e_core.redis_connections.redis_area_market_communicator.AggregatorHandler",
