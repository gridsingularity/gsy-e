...
class SimulationTest(unittest.TestCase):
    ...
    @staticmethod
    def test_results_not_send_via_kafka_if_started_from_cli(self):
        redis_job_id = None
        ...
        simulation.endpoint_buffer.results_handler.all_ui_results = \
            {k: {} for k in results_mapping.keys()}
    ...
    @staticmethod
    def test_results_are_send_via_kafka_if_not_started_from(self):
        redis_job_id = "1234"
        simulation_config = SimulationConfig(duration(hours=int(12)),
                                             duration(minutes=int(60)),
                                             duration(seconds=int(60)),
