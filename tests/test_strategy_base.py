...
@pytest.mark.parametrize('market_class', [OneSidedMarket, TwoSidedMarket, TwoSidedPayAsClear])
...
@pytest.mark.parametrize('market_class', [TwoSidedMarket, TwoSidedPayAsClear])
